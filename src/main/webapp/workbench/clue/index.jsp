...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#searchBtn").click(function () {
			...
			$("#hide-createBy").val($.trim($("#search-createBy").val()));
	...
	function pageList(pageNo,pageSize) {
		...
		$("#search-createBy").val($.trim($("#hide-createBy").val()));
...
<body>
			<input id="hide-fullname" type="hidden">
			<input id="hide-company" type="hidden">
			<input id="hide-phone" type="hidden">
			<input id="hide-mphone" type="hidden">
			<input id="hide-source" type="hidden">
			<input id="hide-createBy" type="hidden">
			<input id="hide-state" type="hidden">
