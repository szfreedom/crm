...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#aname").keydown(function (event) {
			if (event.keyCode==13){
				$.ajax({
					url:"workbench/clue/getActivityByClueIdAndByName.do",
					data:{
	...
	function unband(id) {
		alert(id);
		$.ajax({
			url:"workbench/clue/unbandActivity.do",
			data:{
					"id":id
			},
			type:"post",
...
<body>
		...
		<div class="modal-dialog" role="document" style="width: 80%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" id="bandBtn">关联</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
			<button type="button" class="btn btn-default" onclick="window.location.href='workbench/clue/convert.jsp?id=${c.id}&fullname=${c.fullname}&company=${c.company}&owner=${c.owner}&appellation=${c.appellation}';"><span class="glyphicon glyphicon-retweet"></span> 转换</button>
