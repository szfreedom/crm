			...
			$.ajax({
				...
				success:function (data) {
					if (data.success){
						...
						$("#e"+id).html(data.u.noteContent);
						$("#s"+id).html(data.u.editTime+" 由"+data.u.editBy);
					}
				}
			})
		})
...
<body>
	...
	<div style="position: relative; top: -70px;">
		<div style="position: relative; left: 40px; height: 30px;">
			...
			<div style="width: 300px;position: relative; left: 650px; top: -60px;" onclick="window.location.href='workbench/activity/index.jsp'"><b>${a.name}</b></div>
