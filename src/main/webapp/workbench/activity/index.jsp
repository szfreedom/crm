...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#searchBtn").click(function(){
			...
			$("#hide-startDate").val($.trim($("#search-startTime").val()));
			$("#hide-endDate").val($.trim($("#search-endTime").val()));
	...
	function pageList(pageNo,pageSize) {
		...
		$("#search-startTime").val($.trim($("#hide-startDate").val()));
		$("#search-endTime").val($.trim($("#hide-endDate").val()));
		$.ajax({
